  ...
  return (
    <div className="bg-[#f4f0ff] w-full h-full min-h-screen p-0 m-0">
      <div className="space-y-4">
        ...
        {user.age !== undefined && (
          <ProfileDetailItem label={labels.age || "Age"} value={user.age} />
        )}
        {user.gender && (
          <ProfileDetailItem
        ...
        {user.dateOfBirth && (
          <ProfileDetailItem
            label={labels.dateOfBirth || "Date of Birth"}
        ...
        <ProfileDetailItem
          label={labels.countryOfOrigin || "Country of Origin"}
          value={user.countryOfOrigin}
        />
        <ProfileDetailItem
          label={labels.dateOfRegistration || "Date of Registration"}
          value={user.dateOfRegistration}
        />
        {user.challenges && user.challenges.length > 0 && (
          <ProfileDetailItem
            label={labels.keyChallenges || "Key Challenges"}
            value={user.challenges}
            isList
          />
        )}
        {user.bio && (
